...
The current application code release is Git commit `e710fbd`, image `torob-rent:e710fbd`, release directory `/opt/torob-rent/releases/e710fbd`, including the Persian Jalali calendar popup. The initial release and previous `e99ec7b` image remain available for rollback. Later documentation-only commits do not require rebuilding the application.
